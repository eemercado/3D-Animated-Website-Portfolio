...
type SocialDocumentDataSlicesSlice =
  | LinkSlice
  | ImageBlockSlice
  | TextBlockSlice;
...
interface SocialDocumentData {
  /**
   * Title field in *Social*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: social.title
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;
  ...
  /**
   * Date field in *Social*
   *
   * - **Field Type**: Date
   * - **Placeholder**: *None*
   * - **API ID Path**: social.date
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#date
   */
  date: prismic.DateField;
  ...
  /**
   * Hover Image field in *Social*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: social.hover_image
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  hover_image: prismic.ImageField<never>;
  ...
  /**
   * Slice Zone field in *Social*
   *
   * - **Field Type**: Slice Zone
   * - **Placeholder**: *None*
   * - **API ID Path**: social.slices[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#slices
   */
  slices: prismic.SliceZone<SocialDocumentDataSlicesSlice> /**
   * Meta Title field in *Social*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A title of the page used for social media and search engines
   * - **API ID Path**: social.meta_title
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */;
  meta_title: prismic.KeyTextField;
  ...
  /**
   * Meta Description field in *Social*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A brief summary of the page
   * - **API ID Path**: social.meta_description
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  meta_description: prismic.KeyTextField;
  ...
  /**
   * Meta Image field in *Social*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: social.meta_image
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  meta_image: prismic.ImageField<never>;
...
export interface ContentIndexSliceDefaultPrimary {
   ...
   */
  content_type: prismic.SelectField<"Blog" | "Project" | "Social">;
...
export interface LinkSliceDefaultPrimary {
  /**
   * Linkk field in *Link → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: link.primary.linkk
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  linkk: prismic.LinkField;
